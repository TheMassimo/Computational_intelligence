...
class AbstractProblem:
    ...
    @staticmethod
    def onemax(genome):
        #print how many elements have 1
        return sum(bool(g) for g in genome)

    def __call__(self, genome):
        self._calls += 1
        #pick elements jumping from x in x and call one max in this new subset
        #after that it sort the values obtained and use reverse to put the best one in first position 
